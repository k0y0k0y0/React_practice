  ...
  render(){
    return(
      <form onSubmit={this.props.handleSubmit(this.onSubmit)} className='ui form error'>
        <Field name='titile' component={this.renderInput} label='Title' placeholder='Enter title'/>
        <Field name='description' component={this.renderInput} label='Description' placeholder='Enter description'/>
